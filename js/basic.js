...
function addCurrentToNavDays(numCurrent) {
	...
	var allgliderElements = document.querySelectorAll(".navDays");
...
function removeAnchors() {
	var xyz = document.getElementById("footer-testata").getElementsByTagName("a");
	[].forEach.call(xyz, function(div) {
